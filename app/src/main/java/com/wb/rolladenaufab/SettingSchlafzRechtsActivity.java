...
public class SettingSchlafzRechtsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_setting_schlafzrechts);
        ...
        TextView textView = findViewById(R.id.schlafzrechtsTextView);
